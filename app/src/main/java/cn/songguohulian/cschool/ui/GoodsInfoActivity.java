...
import cn.songguohulian.cschool.app.CallCenterActivity;
...
import cn.songguohulian.cschool.utils.VirtualkeyboardHeight;
import cn.songguohulian.cschool.view.NumberAddSubView;
...
public class GoodsInfoActivity extends Activity implements View.OnClickListener {
    ...
    public void setDataFormView(GoodsBean goodsBean) {
        ...
        Glide.with(this).load(MyContants.BASE_URl_IMAGE + figure).into(ivGoodInfoImage);
        if (name != null) {
    ...
    private void showPopwindow() {
        ...
        // 加载图片
        Glide.with(GoodsInfoActivity.this).load(MyContants.BASE_URl_IMAGE + goods_bean.getFigure()).into(iv_goodinfo_photo);
